<h1 align="center">Hyprland Dots Work</h1>
...
```
yay -S swaync yazi ghostty firefox zsh starship eza fd fzf lazygit ripgrep fastfetch zoxide sherlock-launcher-bin bluetuith swappy gimp playerctl hyprshot hyprpaper hyprlock hyprland waybar pamixer pavucontrol wttrbar vesktop neovim unzip unrar openssh ttf-jetbrains-mono-nerd ttf-firacode-nerd obs-studio snapper grub-btrfs snap-pac
```
